...
/////////////////
const BotName = 'Nonna Bot'; 
const instagram = 'https://instagram.com/dylonelys'; 
const telegram = 'https://t.me/Dylon1'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/channel/UCW6HV3-WOrzICAgKF_94kIg?view_as=subscriber';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by DylonKejhu')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by DylonKejhu`)
})
